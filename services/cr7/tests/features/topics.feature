Feature: Topics & Article
  ...
  Scenario: 管理员创建一个新的话题
    When 管理员创建话题，标题为 "展会亮点"
     And 描述为 "介绍展会的亮点和特色"
     And 封面图片为 "http://example.com/cover.jpg"
    Then 话题创建成功
     And 话题的标题为 "展会亮点"
     And 话题描述应为 "介绍展会的亮点和特色"
     And 话题封面图片应为 "http://example.com/cover.jpg"

  Scenario: 管理员修改话题信息
    Given 话题 "展会亮点" 已创建
    When 管理员修改话题的描述为 "更新后的话题描述"
     And 话题封面图片为 "http://example.com/new_cover.jpg"
    Then 话题修改成功
     And 话题描述应为 "更新后的话题描述"
     And 话题封面图片应为 "http://example.com/new_cover.jpg"
  ...
  Scenario: 管理员在话题下发布文章
    ...
    When 用户查看文章详情
    Then 文章的标题应为 "必看展位"
     And 文章的内容应为 "介绍必看的展位和产品"
     And 文章的封面图片应为 "http://example.com/article_cover.jpg"
     And 文章属于话题 "展会亮点"
  ...
  Scenario: 管理员修改文章内容
    ...
    Then 文章修改成功
     And 文章的内容应为 "更新后的文章内容，介绍更多必看的展位和产品"
     And 文章的封面图片应为 "http://example.com/new_article_cover.jpg"

  Scenario: 用户查看 topics 列表
    Given 话题 "展会亮点" 已创建
      And 话题描述为 "话题描述"
      And 话题封面图片为 "http://example.com/cover.jpg"
