<template>
  <view class="profile-edit-page">
    ...
    <view class="form-container">
      <!-- 头像 -->
      <view class="form-card" @click="openAvatarActionSheet">
      ...
      <!-- 昵称 -->
      <view class="form-card" @click="openEdit('nickname')">
        <text class="form-label">昵称</text>
        <view class="form-right">
          <text class="form-text">
            {{ form.nickname || "去设置昵称" }}
          </text>
          <text class="form-link" @click.stop="useWechatNickname"
            >用微信昵称</text
          >
          <image
            src="/static/icons/arrow-right.svg"
      ...
      <!-- 邮箱 -->
      <view class="form-card" @click="openEdit('email')">
      ...
      <!-- 手机：只读，无箭头 -->
      <view class="form-card form-card-readonly">
        <text class="form-label">手机</text>
        <view class="form-right">
          <text class="form-text form-text-muted">
            {{ form.phone || "当前登录手机号" }}
          </text>
        </view>
      </view>
